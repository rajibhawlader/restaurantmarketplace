		...
		switch ($_REQUEST["action"]) 
		{
			...
			case 'registration':
								...
								if($tecncode==$oencode)
								{
								   ...
								   $queryr = "INSERT INTO  resturant  VALUES ('', '$postid',  '', '', '".
							       ...
							       $arreturnvalue = array('body' => 'registratiionsuccess.html');
									...
									$body_txt = ' Dear '.$fname.' '.$lname.'  <br />
												...
												<br>
												To activate your account  <a href="index-action-activeuser-uid='.$postid.'" target="_blank">Click here</a>. <br />
												Many Thanks<br />
...
<!--<link href="http://indianfoodsonline.co.uk/style.css" rel="stylesheet" type="text/css">-->
		      ...
		      <tr>
			   ...
			   <?	 }	?>
				...
				<td width="23%" valign="top">
						<?php  require_once('includes/reight_panal.html');?></td>
				<? }	?>
