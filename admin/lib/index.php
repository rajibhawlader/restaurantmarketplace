...
case 'cms_page_view':
 ...
 case 'update_cms_page':
	...
	case 'update_status':
		...
		{
		 $query = "Update customer_order set pstatus='".$_REQUEST['pstatus']."',dstatus='".$_REQUEST['dstatus']."' WHERE orid= '".$_REQUEST["orid"]."'";
		...
		$restaura_image=implode("|",$img);				
									...
									if($_REQUEST[rid]!="")
									{
												...
												$query = "Update  userregistration  set first_name='".mysql_escape_string($_REQUEST["first_name"])."', last_name='"
														...
														.nl2br($_REQUEST["address1"])."',status='1' where id='$ids'";
					...
					$query = "INSERT INTO  userregistration(`id` ,`first_name` ,`last_name` ,`phone` ,`mobile` ,`fax` ,`email` ,`address1` 	,`password` ,`status`)
								 ...
								 '".mysql_escape_string($_REQUEST["fax"])."', '".mysql_escape_string($_REQUEST["email"])."', '".nl2br($_REQUEST["address1"])."',
...
`image5`,`image6`,`image7`,`image8`,`building`,`address2`,`county`) VALUES('','$postid','".mysql_escape_string($_REQUEST["area_id"])."','".mysql_escape_string($_REQUEST["chinise_id"])."','".mysql_escape_string($_REQUEST["rname"])."','".mysql_escape_string(
												$_REQUEST["street"])."','".mysql_escape_string($_REQUEST["city"])."','".mysql_escape_string($_REQUEST["zipcode"])."','"
...
Image_resize($userfile_name, $userfile_tmp, $userfile_size, $userfile_type,0,$postid);
		...
		$userfile_name = $_FILES['c_img']['name'];
            ...
            $query = "Update resturant set area_id='".mysql_escape_string($_REQUEST["area_id"])."',chinise_id='".mysql_escape_string($_REQUEST["chinise_id"])."',rname='".mysql_escape_string($_REQUEST["rname"])."',street='".mysql_escape_string($_REQUEST["street"])."',city='".mysql_escape_string($_REQUEST["city"])."',zipcode='".mysql_escape_string($_REQUEST["zipcode"])."',country_id='".mysql_escape_string($_REQUEST["country_id"])."',contact='".mysql_escape_string($_REQUEST["contact"])."',contact2='".mysql_escape_string($_REQUEST["contact2"])."',contact3='".mysql_escape_string($_REQUEST["contact3"])."',contact4='".mysql_escape_string($_REQUEST["contact4"])."',web='".mysql_escape_string($_REQUEST["web"])."',logo='$prod_img_thumbs',rdesc='".nl2br(mysql_escape_string($_REQUEST["rdesc"]))."',keytitle='".nl2br(mysql_escape_string($_REQUEST["keytitle"]))."',profile='".mysql_escape_string($_REQUEST["profile"])."',building='".mysql_escape_string($_REQUEST["building"])."',address2='".mysql_escape_string($_REQUEST["address2"])."',county='".mysql_escape_string($_REQUEST["county"])."' where rid='".mysql_escape_string($_REQUEST["id"])."'";
			}
			else
			{
			             $query = "Update resturant set area_id='".mysql_escape_string($_REQUEST["area_id"])."',chinise_id='".mysql_escape_string($_REQUEST["chinise_id"])."',rname='".mysql_escape_string($_REQUEST["rname"])."',street='".mysql_escape_string($_REQUEST["street"])."',city='".mysql_escape_string($_REQUEST["city"])."',zipcode='".mysql_escape_string($_REQUEST["zipcode"])."',country_id='".mysql_escape_string($_REQUEST["country_id"])."',contact='".mysql_escape_string($_REQUEST["contact"])."',contact2='".mysql_escape_string($_REQUEST["contact2"])."',contact3='".mysql_escape_string($_REQUEST["contact3"])."',contact4='".mysql_escape_string($_REQUEST["contact4"])."',web='".mysql_escape_string($_REQUEST["web"])."',rdesc='".nl2br(mysql_escape_string($_REQUEST["rdesc"]))."',keytitle='".nl2br(mysql_escape_string($_REQUEST["keytitle"]))."',profile='".mysql_escape_string($_REQUEST["profile"])."',building='".mysql_escape_string($_REQUEST["building"])."',address2='".mysql_escape_string($_REQUEST["address2"])."',county='".mysql_escape_string($_REQUEST["county"])."' where rid='".mysql_escape_string($_REQUEST["id"])."'";
			}
...
/////////////////////////////////////////////Sagar
	...
	case 'insert_deliver_area':
        ...
        if ($_REQUEST["area_id"]=="") {
			...
			if(!$exist)
			{
				$query = "INSERT INTO delivery_area(`area_id` ,`rid` ,`post_code`) VALUES('','$rids','".mysql_escape_string($_REQUEST["post_code"])."')";
		...
		}else
		{
			...
			if(!$exist)
			{
				$query = "Update delivery_area set post_code='".mysql_escape_string($_REQUEST["post_code"])."' where area_id='".$_REQUEST["area_id"]."'";
...
<TABLE WIDTH=100% BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
	<TR>
	  <TD> <?php
  if ($body!="add_menu.html" && $body!="addFood.html" && $body!="addFoodSelection.html" && $body!="edit_menu.html" && $body!="food_item_edit.html" && $body!="selection_food_item_edit.html"){
	...
	if ($tabm!="" and $_SESSION['adminuserid']!=""){
	
	?>
             <? if($tabm!="cmst"){?><td width="232" valign="top"><?php if($tabm=="admu"){require_once "template/admin_user_menue.html";}
