...
var gcCalBG="#CE3337";	// the background color of the outer calendar panel.
...
var gcSatBG="#9C9C9C";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#9C9C9C";	// Sunday background color
