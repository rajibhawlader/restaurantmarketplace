 ...
 *
 * $Id: vars.php.in,v 1.2 2006/10/19 04:21:52 ilobachev Exp $
 */
...
$xrms_db_server = 'localhost:3306';
$xrms_db_username = 'usr0d2e7fed3e44';
$xrms_db_password = 'KTtpf9rp2A0f';
$xrms_db_dbname = 'indianfoodsonline_mysql29edbd35dc7bd3dbf5c688109a20570b';

// where is this application, web-wise? (no trailing slash)
$http_site_root = 'http://indianfoodsonline.co.uk/rms';

// what domain should we use for cookies? (no trailing slash)
$http_cookie_site = 'indianfoodsonline.co.uk';

//where is the appliation in the filesystem (no trailing slash)
$xrms_file_root = '/var/www/vhosts/indianfoodsonline.co.uk/httpdocs/rms';
...
$app_title = 'Indian Foods Online - Customer Management';
